// Backup del diseño original de generarPDF (RemitosController.js), previo a la migración
// a Puppeteer + HTML/CSS. Se conserva tal cual únicamente como referencia histórica del
// layout (coordenadas de cuadros, textos y tabla dibujados a mano con pdfkit).
// No se importa ni se usa en ningún lado del proyecto.
...
export const generarPDF_legacy = async (req, res) => {
...
export default { generarPDF_legacy };
